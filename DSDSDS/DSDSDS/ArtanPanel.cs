...
namespace DSDSDS
{
    public class ArtanPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LinearGradientBrush brushArtan =
            ...
            if (borderRadius > 2)
            {
                using (GraphicsPath graphicsPath =
                    GetArtanPath(rectangleF, borderRadius))
                {
                    using (Pen pen = new Pen(this.Parent?.BackColor ?? Color.White, 1))
                    {
